...
\]
Adding $a_1$ to both sides of the right inequality and rewriting
the left gives the bracket displayed in the statement (with $N$
replaced by $N - 1$). Both partial sums and the partial integrals are
nondecreasing in~$N$ and bounded by each other up to a constant; they
therefore converge or diverge together.
\end{proof}
