...
В следующей теореме одновременно встречаются оператор и матрица
перехода. Договоримся придерживаться сквозной типографской
конвенции: оператор обозначается обычной буквой~$T$, а матрица
перехода~--- полужирной~$\mat{T}$ (как и любая другая матрица).
Эти два символа представляют объекты разной природы, и их
