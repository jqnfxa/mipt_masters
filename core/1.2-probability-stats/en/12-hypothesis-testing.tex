...
$\E_{\theta_0} \varphi^* - \E_{\theta_0} \varphi \geq 0$ (the second
bracket is non-negative), and with $k \geq 0$ this makes
$k(\E_{\theta_0} \varphi^* - \E_{\theta_0} \varphi) \geq 0$.
Rearranging the displayed inequality,
\[
  \E_{\theta_1} \varphi^* - \E_{\theta_1} \varphi \;\geq\; k\bigl(\E_{\theta_0} \varphi^* - \E_{\theta_0} \varphi\bigr) \;\geq\; 0,
\]
i.e.\ $\E_{\theta_1} \varphi^* \geq \E_{\theta_1} \varphi$ — the
